...
if __name__ == '__main__':
    ...
    # 借助 DataCollatorForSeq2Seq 进行动态padding
    data_collator = DataCollatorForSeq2Seq(tokenizer)   # 对序列动态padding
    # train_dataloader = DataLoader(train_dataset, batch_size=6, shuffle=False, collate_fn=data_collator)
