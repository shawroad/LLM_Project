...
if __name__ == '__main__':
    ...
    args.output_dir = 'sft_model_output_lora'
    set_seed()
    ...
    model = AutoModelForCausalLM.from_pretrained(args.pretrain_model, device_map='auto', trust_remote_code=True, torch_dtype=torch.float16)
