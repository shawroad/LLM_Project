...
def load_model_and_tokenizer(pretrain_model_path):
    # 加载预训练模型和 LoRA 权重
...
if __name__ == "__main__":
    ...
    # 加载模型和分词器
    # pretrain_model_path = './DPO_model_output/checkpoint-1500'
    # pretrain_model_path = '../Qwen2.5-1.5B-Instruct'
    
    pretrain_model_path = './DPO_model_output/checkpoint-19862'
    model, tokenizer = load_model_and_tokenizer(pretrain_model_path)
